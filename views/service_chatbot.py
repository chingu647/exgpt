...
#    st.markdown(":rocket: :green[**휴게시설 업무기준**] 및 :sparkles: :green[**자체투자사업 매뉴얼**] 안내")
    ...
    # 🔒 [보안 필수] 함수 시작 직후, 그 어떤 조건문(if)에도 속하지 않는 최상단 위치에 배치하여 상시 노출시킵니다.
    st.error("""⚠️ **[보안 필수 준수 사항]**

🔹 **개인정보·실명 입력 절대 금지**: 사람 이름, 주민번호, 특정 업체 실명 등

🔹 **가명 처리 필수**: **'OO휴게소', '업체A'** 등으로 바꾸어 질문

🔹 **최종 확인 의무**: AI 답변은 참고용. 중요사항은 반드시 원문 확인 필요.""")
